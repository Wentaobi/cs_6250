...
class Topo1(Topo):
    ...
    def __init__(self, n=1, cpu=.1, bw=100, delay=None,
        ...
        hostConfig = {'cpu': cpu}
        ethConfig = {'bw': 10, 'delay': '1ms', 'loss':0, 'max_queue_size': max_queue_size}
        wifiConfig = {'bw': 2, 'delay': '5ms', 'loss':3, 'max_queue_size': max_queue_size}
        threeGConfig = {'bw': 2, 'delay': '75ms', 'loss':2, 'max_queue_size': max_queue_size}
        # TODO
    ...
    #TODO
        ...
        # Wire sender
    #TODO
        self.addLink(sender, s1, 0, uplink, **ethConfig)
        self.addLink(sender, s2, 1, uplink, **ethConfig)
        self.addLink(sender, s3, 2, uplink, **ethConfig)
        # Wire receiver
    #TODO
        self.addLink(s1, receiver, downlink, 0, **ethConfig)
        self.addLink(s2, receiver, downlink, 1, **wifiConfig)
        self.addLink(s3, receiver, downlink, 2, **threeGConfig)
...
def run_parkinglot_expt(net, n):
    ...
    ##  A. Becker (Adds enough of a delay so the system knows MPTCP is available)
    sleep(20)
    ## end
